  ...
  return (
    <div className="flex h-full w-full flex-col glass-sidebar rounded-[24px] relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at top center, rgba(205, 127, 50,0.04) 0%, transparent 70%)' }}
      />

      {/* Brand Header */}
      <div className="flex h-24 shrink-0 items-center px-6 relative" style={{ borderBottom: '1px solid rgba(205, 127, 50,0.1)' }}>
        <div
          className="w-10 h-10 rounded-full flex items-center justify-center mr-3 shrink-0 overflow-hidden shadow-sm bg-black/40"
          style={{ border: '1px solid rgba(205, 127, 50,0.35)', boxShadow: '0 0 15px rgba(205, 127, 50,0.08)' }}
        >
          <span className="font-bold text-primary tracking-wider">VJ</span>
        </div>
        <div>
          <h1 className="text-[17px] font-bold tracking-[0.15em] text-primary uppercase leading-tight">VJ</h1>
          <p className="text-[10px] tracking-[0.2em] text-white/50 uppercase ml-[1px]">Hair Salon</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col overflow-y-auto custom-scrollbar px-3 py-5 bg-transparent">
        <nav className="flex-1 space-y-1">
          <div className="px-3 pb-3">
            <p className="text-[9px] font-bold uppercase tracking-[0.2em]" style={{ color: 'rgba(205, 127, 50,0.3)' }}>
              Navigation
            </p>
          </div>
          {navigation.map((item) => {
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      ...
                      isActive
                        ? 'text-white'
                        : 'text-[#B8B8B8] hover:text-white hover:bg-[rgba(205, 127, 50,0.04)]'
                    )
                  }
      ...
      <div
        ...
        style={{ borderTop: '1px solid rgba(205, 127, 50,0.1)' }}
      >
        {profile && (
          <div
          ...
          >
            <div
              ...
              style={{ background: 'rgba(205, 127, 50,0.1)', border: '1px solid rgba(205, 127, 50,0.25)' }}
            >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] uppercase tracking-wider truncate" style={{ color: 'rgba(205, 127, 50,0.5)' }}>
                {profile.role}
              </p>
            </div>
          </div>
